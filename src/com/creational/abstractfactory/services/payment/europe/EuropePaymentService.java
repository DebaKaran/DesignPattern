...
import com.creational.abstractfactory.services.paymentstrategy.europe.CreditCardPaymentStrategyEurope;
import com.creational.abstractfactory.services.paymentstrategy.europe.SepaPaymentStrategy;
...
public class EuropePaymentService implements PaymentService {

    private final Map<PaymentType, PaymentStrategy> strategies;

    public EuropePaymentService() {
    ...
    public void pay(double amount, PaymentType paymentType) {
        ...
        if (strategy == null) {
            throw new IllegalArgumentException(
                    "Payment type not supported in Europe: " + paymentType
            );
        }
